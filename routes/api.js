...
var creatorList = ['@vall','@rivalgans','@vall.dz','@rivalanjay', '@valldzsss','@rivalganss','@rivalgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'valldz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'valldz') return res.json(loghandler.invalidKey)
